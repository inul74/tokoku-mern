...
const Profile = () => {
  ...
  return (
    <div className="px-4 py-0 lg:px-6 lg:py-6">
      {/**profile upload and display image */}
      <div className="w-20 h-20 bg-blue-100 flex items-center justify-center rounded-full overflow-hidden drop-shadow-sm">
        {user.avatar ? (
